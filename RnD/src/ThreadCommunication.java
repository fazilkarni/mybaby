...
public class ThreadCommunication {
	...
	public static void main(String[] args) {
		...
		BlockingQueue201 q = new BlockingQueue201(10);
...
class Consumer extends Thread{
	BlockingQueue201 q;
	public  Consumer(BlockingQueue201 q){
		this.q = q;
	}
...
class Producer extends Thread{
	BlockingQueue201 q;
	public Producer(BlockingQueue201 q){
		this.q = q;
	}
 ...
 class BlockingQueue201 {

	  private List queue = new LinkedList();
	  private int  limit = 10;

	  public BlockingQueue201(int limit){
	    this.limit = limit;
	  }
